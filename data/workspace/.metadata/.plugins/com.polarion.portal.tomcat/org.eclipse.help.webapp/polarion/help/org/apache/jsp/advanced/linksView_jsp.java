...
public final class linksView_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (new RequestData(application,request, response).isMozilla()) {
	...
	WebappPreferences prefs = data.getPrefs();
      ...
      out.write("\n");
      out.write("<title>");
      out.print(ServletResources.getString("Links", request));
      out.write("</title>\n");
      out.write("\n");
...
if(!data.isLinksRequest()) {
	...
	for (int topic = 0; topic < data.getLinksCount(); topic++) 
	{
      ...
      out.write("' \n");
      out.write("\t\t   href='");
      out.print(data.getTopicHref(topic));
      out.write("' \n");
      out.write("\t\t   onmouseover=\"showStatus(event);return true;\"\n");
      out.write("\t\t   onmouseout=\"clearStatus();return true;\"\n");
      out.write("\t\t   onclick='parent.parent.parent.setContentToolbarTitle(this.title)'\n");
      out.write("\t\t   title=\"");
      ...
      out.print(data.getTopicLabel(topic));
      out.write("</a>\n");
      out.write("\t</td>\n");
      out.write("</tr>\n");
      out.write("\n");
      ...
      out.print(data.getSelectedTopicId());
      out.write("');\n");
      out.write("</script>\n");
      out.write("\n");
      out.write("</body>\n");
